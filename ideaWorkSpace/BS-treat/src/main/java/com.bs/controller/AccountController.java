...
public class AccountController extends BaseController {
    ...
    public String register() {
        return String.format(TREAT_VM_ROOT, "register");
    }
    ...
    public String rule() {
        return String.format(TREAT_VM_ROOT, "rule");
    }
    ...
    public ModelAndView updatePassword(Model model,HttpServletRequest request){
        ...
        return new ModelAndView(String.format(TREAT_VM_ROOT, "updatepassword"));
    }
    ...
    public ModelAndView bindEmail(Model model,HttpServletRequest request){
        ...
        Account account = accountService.getById(sessionDetail.getAccountId());
        model.addAttribute("account",account);
        return new ModelAndView(String.format(TREAT_VM_ROOT, "bindemail"));
    }
