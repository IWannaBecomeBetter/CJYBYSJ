...
public class SysParamDetailConstant {
     ...
     * 康复师等级
     */
    public static final String TREAT_LEVEL_ONE = "1";//初级康复师

    public static final String TREAT_LEVEL_TWO = "2";//中级康复师

    public static final String TREAT_LEVEL_THREE = "3";//高级康复师
     ...
     * 康复治疗师状态
     */
    public static final String TREAT_STATUS_IDENTIFY = "11"; // 认证

    public static final String TREAT_STATUS_PERSON = "12"; // 个人简介
